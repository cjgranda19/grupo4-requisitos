...
public class test {
    ...
    @Given("El cliente ha agregado productos al carrito de compras")
    public void cliente_agrega_productos(){
        try {
            ...
            logger.error("Error al agregar productos", e);
            Assert.fail("Error al agregar productos: " + e.getMessage());
        }
    }

    @Given("Los productos en el carrito están disponibles en inventario")
    public void verificar_disponibilidad_inventario(){
        try {
            ...
            Assert.assertTrue("El producto 1 no está disponible", product1.getText().contains("Disponible"));
            Assert.assertTrue("El producto 2 no está disponible", product2.getText().contains("Disponible"));
            Assert.assertTrue("El producto 3 no está disponible", product3.getText().contains("Disponible"));
        } catch (Exception e) {
    ...
    @Then("El cliente puede actualizar su carrito de compras")
    ...
    @Then("El cliente puede intentar realizar el pago nuevamente")
    ...
    @Given("Un producto en el carrito no está disponible en inventario")
    public void producto_no_disponible_en_inventario(){
        try {
            ...
            logger.error("Error al marcar productos como no disponibles", e);
            Assert.fail("Error al marcar productos como no disponibles: " + e.getMessage());
        }
    }
